...
BOOL CPdfTronHelper::Pdf2EmbeddedFontPdf(const std::string sOutPdfPath,bool bDelOri)
{
	return d_ptr->Pdf2EmbeddedFontPdf(sOutPdfPath,bDelOri);
}

BOOL CPdfTronHelper::GetSysFontNameInfoByName(std::wstring& wsFontNameZh, std::wstring& wsFontNameEn, const std::wstring wsFontName)
{
	return d_ptr->GetSysFontNameInfoByName(wsFontNameZh,wsFontNameEn,wsFontName);
